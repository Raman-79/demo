...
parser.add_argument("--model-arn", help="ARN of the model to call, e.g., arn:aws:bedrock:us-east-1:123456789012:model/anthropic.claude-instant-v1", required=True)
parser.add_argument("--embedding-model-arn", help="ARN of the embedding model to call, e.g., arn:aws:bedrock:us-east-1:123456789012:model/amazon.titan-embed-text-v1", required=True)
parser.add_argument("--knowledgebase-arn", help="ARN of the Knowledge Base", required=True)
...
REGION = args.region
BEDROCK_MODEL_ARN = args.model_arn
BEDROCK_EMBEDDING_MODEL_ARN = args.embedding_model_arn
BEDROCK_KNOWLEDGEBASE_ARN = args.knowledgebase_arn
...
bedrock_embeddings = BedrockEmbeddings(    
    region_name=REGION, model_id=BEDROCK_EMBEDDING_MODEL_ARN
)
...
retriever = AmazonKnowledgeBasesRetriever(
    knowledge_base_id=BEDROCK_KNOWLEDGEBASE_ARN,
    retrieval_config={
